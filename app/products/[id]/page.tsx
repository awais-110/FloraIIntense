...
export async function generateMetadata({ params }: ProductPageProps) {
  ...
  return {
    title: product
      ? `${product.name} — Floral Intense`
      : "Product — Floral Intense",
          ...
          <div className="detail-copy">
            ...
            <div className="detail-info-grid">
              <article>
                ...
                <p>Designed for strong presence and premium dry-down.</p>
              </article>

              <article>
                <strong>Gift Ready</strong>
                <p>Clean presentation suitable for special occasions.</p>
              </article>

              <article>
                <strong>Easy Ordering</strong>
                <p>Add to cart or order directly through WhatsApp.</p>
              </article>
            </div>
          </div>
        </section>
